...
function Gallery() {
    ...
    let [enlargeImage, setEnlargeImage] = useState(false);
    ...
    function handleEnlargeImage(image) {
        setEnlargeImage(!enlargeImage[image]);
    }
                                    ...
                                    <div className="card mb-4" >
                                        {
                                            !enlargeImage ?
                                                ...
                                                :
                                                //         <dialog className="enlarged"
                                                //             style={{ position: 'absolute' }}
                                                //             open onClick={handleEnlargeImage.bind(null, image)}>
                                                //             image && image.images && image.images[0] ?
                                                // <img className="card-img-top m-auto p-1" src={image.images[0].link} onError={handleImgError} /> : <img className="card-img-top m-auto p-1" src="https://picsum.photos/200/300" onError={handleImgError} />
                                                //         </dialog>
